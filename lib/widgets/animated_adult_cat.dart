...
/// 성체(3단계, 졸업 예정) 고양이 전용 애니메이션 위젯.
///
/// assets/growth/adult_frames/adult_01.png ~ adult_15.png 15장의 각기 다른
/// 포즈(손흔들기/윙크/하이파이브/눕기/인사 등, 학사복 차림) 스티커 프레임을
/// 순서대로 부드럽게 크로스페이드하며 돌려서, 마치 살아 움직이는 것처럼
/// 보여줍니다. 청소년 고양이([AnimatedTeenCat])와 완전히 동일한 방식
/// (프레임 순환 크로스페이드 + 부유/숨쉬기/통통튐/씰룩임 물리 애니메이션)으로
/// 톤을 통일했습니다.
class AnimatedAdultCat extends StatefulWidget {
  final double size;
  const AnimatedAdultCat({super.key, this.size = 132});

  @override
  State<AnimatedAdultCat> createState() => _AnimatedAdultCatState();
}

class _AnimatedAdultCatState extends State<AnimatedAdultCat>
    with TickerProviderStateMixin {
  static const List<String> _frames = [
    'assets/growth/adult_frames/adult_01.png',
    'assets/growth/adult_frames/adult_02.png',
    'assets/growth/adult_frames/adult_03.png',
    'assets/growth/adult_frames/adult_04.png',
    'assets/growth/adult_frames/adult_05.png',
    'assets/growth/adult_frames/adult_06.png',
    'assets/growth/adult_frames/adult_07.png',
    'assets/growth/adult_frames/adult_08.png',
    'assets/growth/adult_frames/adult_09.png',
    'assets/growth/adult_frames/adult_10.png',
    'assets/growth/adult_frames/adult_11.png',
    'assets/growth/adult_frames/adult_12.png',
    'assets/growth/adult_frames/adult_13.png',
    'assets/growth/adult_frames/adult_14.png',
    'assets/growth/adult_frames/adult_15.png',
  ];
